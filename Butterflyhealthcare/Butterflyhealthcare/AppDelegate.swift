...
//        ]
//
//        let request = NSMutableURLRequest(url: NSURL(string: "https://api.themoviedb.org/3/genre/movie/list?language=en")! as URL,
...
//        dataTask.resume()
    ...
    func callWebServiceCall() -> Void {
        
        let bearerString = "Bearer "
        let authorization = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2ZTBiYWMzNjJjYTkwNzA0MDc1OTRhYWJjMjcwNTVhNSIsInN1YiI6IjY1OGY3NWY1ZWZjZWE5MDFmNWY5ZWVjMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.giLwC2hqd_0O9ShK8gaHSHRXXy8Pg6-hjDzLFU5nsQA"
...
//                completion(errorResponse,data)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Butterflyhealthcare")
